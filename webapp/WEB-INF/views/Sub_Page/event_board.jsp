	...
	<div id="Board_main">
		<div id="event_board">
			...
			<tr>
				...
				<td><a href="/gs25/Sub_Page/view?no=${vo.no}"><img src="${vo.imageurl }" width="250px" height="100px"></a></td>
				<td><a href="/gs25/Sub_Page/view?no=${vo.no}">${vo.title }</a>
		...
		<!-- begin:paging -->
			<div class="pager">
				<ul>
					...
					<li><a href="/gs25/Sub_Page/eventlist?p=${map.prevtoPage }">◀◀</a></li>
					</c:if>
					<c:if test="${map.prevPage >= 0 }">
						<li><a href="/gs25/Sub_Page/eventlist?p=${map.prevPage }">◀</a></li>
					</c:if>
				...
				<c:choose>
					...
					<c:otherwise>
					<li><a href="/gs25/Sub_Page/eventlist?p=${i }">${i }</a></li>
					</c:otherwise>
				</c:choose>
				</c:forEach>

							<c:if test='${map.nextPage > 0 }'>
								<li><a href="/gs25/Sub_Page/eventlist?p=${map.nextPage }">▶</a></li>
							</c:if>
							<c:if test='${map.nexttoPage > 0 }'>
								<li><a href="/gs25/Sub_Page/eventlist?p=${map.nexttoPage }">▶▶</a></li>
							</c:if>
