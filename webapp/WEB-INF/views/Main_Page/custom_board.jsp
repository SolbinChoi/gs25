	...
	<div id="container">
		...
		<div id="content">
			...
			<div id="customBoard_main">
				...
				<div id="custom_wrap">
					<div id="main_center">
						<img src="/gs25/assets/images/custom/customer_center.jpg">
					</div>

					<div id="store">
						<img src="/gs25/assets/images/custom/store.png"
							width="550px">
					</div>
					<div id="tel">
						<img src="/gs25/assets/images/custom/tel.png" height="300px">
					</div>
				</div>
				...
				<div id="custom_board">
							...
							<tr>
								...
								<c:choose>
									<c:when test='${vo.depth == 1 }'>
										<td><img src="/gs25/assets/images/custom/que.PNG"></td>
									</c:when>
									<c:otherwise>
										<td><img src="/gs25/assets/images/custom/an.PNG"></td>
									</c:otherwise>
								</c:choose>
					...
					<td style="text-align:left; padding-left:${vo.depth*10}px">
						<c:if test='${vo.depth > 1 }'>
							<img src="/gs25/assets/images/custom/re2.png">
